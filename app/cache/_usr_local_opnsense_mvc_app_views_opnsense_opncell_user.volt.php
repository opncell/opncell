...
<ul class="nav nav-tabs" data-tabs="tabs" id="maintabs">
    <li id="ProfileList" class="active"><a data-toggle="tab" href="#profile-list"><b><?= $lang->_('Profile List') ?></b></a></li>
...
<div class="tab-content content-box">
    ...
    <div id="bulkinsert" class="tab-pane fade in">
        <div class="col-md-12">
            ...
            <br>
            <?= $this->partial('layout_partials/base_form', ['fields' => $bulkForm, 'id' => 'frm_bulk_settings']) ?>
            <br>
    ...
    <div id="user-list" class="tab-pane fade in">
        ...
        <table id="grid-user-list" class="table table-condensed table-hover table-striped table-responsive"
            ...
            <tr>
                ...
                <th data-column-id="commands" data-width="7em" data-formatter="commands" data-sortable="false"><?= $lang->_('Commands') ?>
                </th>
...
<?= $this->partial('layout_partials/base_dialog', ['fields' => $formDialogEditUser, 'id' => 'DialogUsers', 'label' => $lang->_('Change user Profile:'), 'hasSaveBtn' => 'true']) ?>
<?= $this->partial('layout_partials/base_dialog', ['fields' => $formDialogAddUser, 'id' => 'DialogAddUsers', 'label' => $lang->_('Add Subscriber:'), 'hasSaveBtn' => 'true']) ?>
<?= $this->partial('layout_partials/base_dialog', ['fields' => $formDialogEditProfile, 'id' => 'DialogProfile', 'label' => $lang->_('Edit Profile Details:'), 'hasSaveBtn' => 'true']) ?>
